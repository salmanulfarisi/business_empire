...
const profileButtonIconList = [icOrder, icOrder, icMessages];

const paymentMethodList = [imgPaypal, imgStripe, imgCod];
const paymentMethodTitle = [paypal, stripe, cod];
