...
const wholesaleImage =
    "https://i0.wp.com/askan.biz/wp-content/uploads/2019/05/Rungis-11.jpg?resize=800%2C532&ssl=1";
const dressShopImage =
    "https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2xvdGhlcyUyMHNob3B8ZW58MHx8MHx8&w=1000&q=80";
const backeryShopImage =
    "https://images.unsplash.com/photo-1654682941022-2f3ec32a09e5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80";
const shoeShopImage =
